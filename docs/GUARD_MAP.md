...
anti-fabrication belt guards a different cause and stays whole. **New mechanism count: 84**
(mechs. 81–83 above + mech. 84, the `answer_denied` corroboration source added in the W1 harden fix-loop).
