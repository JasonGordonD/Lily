...
Pinned at ticket start: `main @ c9e64ff`  
...
|---|---|---|---|
| P0-1 | False clean slate impossible | Returner/unsettled cannot air clean slate, no saved voices, or no past games; exact 22:03 fixture | **Completed in this change** |
| P0-2 | Multi-intent before start | Voice + adult + pictures + consent + play are consumed before any Round One; setup blocks start until complete | Next |
| P0-3 | Explicit 18+ consumes gate | Clear 18+/age/birth-year text latches consent; no same-session re-ask without cause | Queued |
