...
class LilyGame(lily_transition.LilyTransitionMixin, lily_supply.LilySupplyMixin, lily_identity.LilyIdentityMixin, lily_speech_delivery.LilySpeechDeliveryMixin):
